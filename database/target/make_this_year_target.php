...
function create_database_for_this_year_target($yearr)
{
...
function create_months_to_this_year_target($yearr)
{
  $servername = "localhost";
  $username = "root";
  $password = "toor8";
  ...
  if ($conn->connect_error)
    ...
    {
        $create_new_table_am ="CREATE TABLE target_".$arry_months[$a_a]." (t_id INT AUTO_INCREMENT PRIMARY KEY, t_title varchar(255),t_description varchar(500),t_color varchar(25),t_priority varchar(1),t_start_day varchar(5),t_end_day varchar(5),t_start_hour varchar(2),t_end_hour varchar(2),t_status varchar(50),t_last_modify_time varchar(50),t_last_status_time varchar(50)) CHARACTER SET utf8 COLLATE utf8_persian_ci;";
